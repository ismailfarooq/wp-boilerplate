<p><img src="http://wp_theme.io/images/wp_theme100.svg" width="260" alt="wp_theme"></p>

[![GitHub release](https://img.shields.io/github/release/jeffreyvr/wp_theme?include_prereleases=&sort=semver)](https://github.com/jeffreyvr/wp_theme/releases/)
[![License](https://img.shields.io/badge/License-MIT-blue)](#license)

# Introduction

wp_theme is a minimal boilerplate theme for WordPress using [Tailwind CSS](https://tailwindcss.com/).
...
```bash
composer global require jeffreyvanrossum/wp_theme-installer

wp_theme new example-theme
```

*If the wp_theme command is not found, make sure to place Composer's global vendor bin in your `$PATH` ([see](#command-wp_theme-not-found)).*
...
* Clone repo `git clone https://github.com/jeffreyvr/wp_theme.git && cd wp_theme`
...
### CSS classes generated by wp_theme
...
### Command `wp_theme` not found

Make sure to place Composer's global vendor bin directory in your `$PATH` so the `wp_theme` executable can be found by your system. This directory exists in different locations based on your operating system; however, some common locations include:
...
* [wp_theme website](https://wp_theme.io)
...
* [All contributors](https://github.com/jeffreyvr/wp_theme/graphs/contributors)
